...
import EditCaregiversList from "./EditCaregiversList";
import "./CaregiversList.scss";
                ...
                <div className="row">
                  <div className="col-xs-12 col-lg-12 col-md-12 col-sm-12">
                    <Card className="vaccinate-appoinment__card card-style">
                      <Card.Header>My caregivers List</Card.Header>
                      <Card.Body>
                          ...
                          <div className="vaccinate-appoinment--list">
                            <div>
                              ...
                              >
                                ...
                                <Modal.Body>
                                  <EditCaregiversList></EditCaregiversList>
                                </Modal.Body>
                                <Modal.Footer>
                                  <Button
                                    className="close-btn"
