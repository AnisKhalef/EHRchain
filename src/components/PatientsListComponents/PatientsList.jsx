...
import EditPatientsList from "./EditPatientsList";
...
import PatientModal from "../ModalPatient/AddPatientModal";
                ...
                <div className="row">
                  <div className="col-xs-12 col-lg-12 col-md-12 col-sm-12">
                    <Card className="vaccinate-appoinment__card card-style">
                      <Card.Header>Patients List</Card.Header>
                      <Card.Body>
                          ...
                          <div className="vaccinate-appoinment--list">
                            <div>
                              ...
                              >
                                ...
                                <Modal.Body>
                                  <EditPatientsList></EditPatientsList>
                                </Modal.Body>
                                <Modal.Footer>
                                  <Button
                                    className="close-btn"
